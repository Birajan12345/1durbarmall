...
@section('guest')
    <!-- BEGIN LOGIN SECTION -->
    <video width="100%" height="auto" muted autoplay loop style="position: fixed;">
        <source src="{{asset('assets/images/1durbarmall/1DM VIDEO (1).mp4')}}" type="video/mp4">
    </video>
    <section class="section-account">
        <div class="row col-md-12 logo" align="center" style="margin-top: 15px">
            <img src="{{asset('assets/images/1durbarmall/logo/logo2.jpg')}}" alt="logo" height="150">
        </div>
        <div class="row col-md-12" align="center">
            <div class="card col-sm-4 col-sm-offset-4 ">
                <div class="card-body">
                    <br/>
                    <span class="text-lg text-bold text-primary" style="color: #C0985B">{{ ('1 DURBAR MALL ADMIN PANEL') }}</span>
                    <br/><br/>
                    ...
                    <form class="form form-validate" role="form" style="text-align:left;" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-6 text-right">
                                <button class="btn btn-primary btn-raised" type="submit" style="background-color: #C0985B;
    border-color: #C0985B;">Login</button>
                            </div><!--end .col -->
                        </div><!--end .row -->
                    </form>
                </div>
