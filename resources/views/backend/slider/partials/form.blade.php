    ...
    <div class="col-sm-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="text-default-light">Featured Image(Dimension: 1349 X 510)</label>
                        @if(isset($photo) && $photo->image)
                            <input type="file" name="image" class="dropify" data-default-file="{{ asset($photo->image->path) }}"/>
                        @else
